...
class AnsibleApi(object):
    ...
    #         self.callback = ResultCallback()
    #         filenames = [
    #             '' + '/handlers/ansible/v1_0/sudoers.yml']  # playbook的路径
    #         template_file = ''  # 模板文件的路径
    #         if not os.path.exists(template_file):
    #             sys.exit()

    #         extra_vars = {}  # 额外的参数 sudoers.yml以及模板中的参数，它对应
    #         # ansible-playbook test.yml --extra-vars "host='aa' name='cc' "
    ...
    #             playbooks=filenames, inventory=self.inventory,
    #             variable_manager=self.variable_manager,
    #             loader=self.loader,
